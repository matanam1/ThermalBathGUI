...
namespace ThermalBathGUI
{
    internal class TestController
    {
        ...
        public List<TDAU1Controller> tdauList;
        private int bathCom;
        ...
        public TestController()
        {
            ...
            this.tdauList = new List<TDAU1Controller>();
            this.user = String.Empty;

            this.projId = -1;
            this.projStep = String.Empty;
            this.email = String.Empty;
            this.temperatureList = new List<Double>();
        }
        ...
        public int getBathCom() { return bathCom; }
        public void setBathCom(int bathCom) { this.bathCom = bathCom; }
        ...
        public void printTest()
        {
            ...
            {
                Console.Write("TDAU S/N: " + tdau.getSerialNumber() + " COM" + tdau.getCom() + " , conection status: " + tdau.getCnnectStatus() + "\n");
            }
        }
        ...
        public List<Double> getTemperatureList() { return this.temperatureList; }
        public void addTemperature(double temperature) {  this.temperatureList.Add(temperature); }
        public void clearTemperatureList() {  temperatureList.Clear(); }

        public void addTdau(TDAU1Controller tdau)
        {
            tdauList.Add(tdau);
        }

        public TDAU1Controller getTdauByCom(int com)
        {
            foreach (TDAU1Controller tdau in tdauList)
            {
                if (tdau.getCom() == com)
                {
                    return tdau;
        ...
        public void disconnect()
        {
            ...
            foreach (var tdau in tdauList.ToList())
            {
